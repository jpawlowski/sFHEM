        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form id="form">
                    ...
                    <div class="form-group col-md-4">
                        <label for="txtCustomTblName">Table Name</label> <span class="badge badge-primary">Following Laravel Table Convention</span>
                    ...
                    <div class="col-md-12">
                        <div class="form-group col-md-1 margtop">
                            <label style="font-size: 18px">Fields</label>
                        </div>
                        <div class="form-group col-md-11 margtop">
                            <label class="alert alert-warning">The Primary key <label class="badge badge-warning">( id )</label> and Timestamps <label class="badge badge-warning">( created_at and updated_at )</label> will be created automatically for your table,so no need to add</label>
                        </div>
                    </div>
...
@section('footer_scripts')
    <script language="javascript" type="text/javascript" src="{{ asset('assets/js/jquery.min.js') }}"></script>
...
//        $.ajax({
//            url: 'generator_menu/generate',
//            type: "POST",
//            data: {_token: $('meta[name="_token"]').attr('content'),'icon_name':icon_name},
//            success: function (result) {
//
//            },
//            error: function (result) {
