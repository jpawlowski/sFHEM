...
<head>
    ...
    <link href="{{ asset('assets/css/app_white.css') }}" rel="stylesheet" type="text/css"/>
    <!-- font Awesome -->
...
<header class="header">
    <a href="{{ route('home') }}" class="logo">
        <img src="{{ asset('assets/img/fhem_logo.svg') }}" alt="logo" width="42px" height="42px">
    </a>
